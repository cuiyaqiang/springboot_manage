 ...
 */
package com.guye.sun.common.utils.excel;
...
import com.guye.sun.common.utils.callback.MethodCallback;
import com.guye.sun.common.utils.collect.ListUtils;
import com.guye.sun.common.utils.excel.annotation.ExcelField;
import com.guye.sun.common.utils.excel.annotation.ExcelFields;
import com.guye.sun.common.utils.lang.DateUtils;
import com.guye.sun.common.utils.lang.ObjectUtils;
import com.guye.sun.common.utils.lang.StringUtils;
import com.guye.sun.common.utils.reflect.ReflectUtils;
...
//		if (ef != null && (ef.type()==0 || ef.type()==type)){
	...
	public <E> List<E> getDataList(Class<E> cls, MethodCallback exceptionCallback, String... groups) throws InstantiationException, IllegalAccessException{
		...
		// Get com.guye.sun.common.utils.excel data
							...
							if (valType == String.class){
								...
								if (ef.fieldType() != Class.class){
									...
									val = Class.forName(this.getClass().getName().replaceAll(this.getClass().getSimpleName(), 
											"com.guye.sun.common.utils.fieldtype."+valType.getSimpleName()+"Type")).getMethod("getValue", String.class).invoke(null, val.toString());
								}
							}
						}
					} catch (Exception ex) {
	...
	public static void main(String[] args) throws Throwable {
		...
		File file = new File("e:\\demo\\export.xlsx");
