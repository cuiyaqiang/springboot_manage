 ...
 */
package com.guye.sun.common.utils.reflect;
...
public class ClassUtils {
	 ...
	 * that an interface is provided this method will com.guye.sun.common.utils.collect implementations. In the case
...
class DefaultVFS extends VFS {
	...
	protected List<String> listResources(JarInputStream jar, String path) throws IOException {
		...
		// Iterate over the entries and com.guye.sun.common.utils.collect those that begin with the requested path
		List<String> resources = new ArrayList<String>();
