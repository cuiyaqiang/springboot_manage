...
public class DiffMatchPatch {
  ...
  private String diff_linesToCharsMunge(String text, List<String> lineArray,
    ...
    // Modifying text would create many large strings to garbage com.guye.sun.common.utils.collect.
   ...
   * which can be shifted sideways to align the edit to a com.guye.sun.common.utils.word boundary.
