 ...
 */
package com.guye.sun.common.utils.text;

import java.util.*;
import com.guye.sun.common.utils.text.DiffMatchPatch.Diff;
import com.guye.sun.common.utils.text.DiffMatchPatch.Patch;
...
public class DiffMatchPatchTest {
  ...
  public void testDiffCleanupMerge() {
    ...
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: No change case.", diffList(new DiffMatchPatch.Diff(EQUAL, "a"), new DiffMatchPatch.Diff(DELETE, "b"), new Diff(INSERT, "c")), diffs);
