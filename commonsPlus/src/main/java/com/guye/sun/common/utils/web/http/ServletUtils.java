 ...
 */
package com.guye.sun.common.utils.web.http;
...
import com.guye.sun.common.utils.collect.MapUtils;
import com.guye.sun.common.utils.io.PropertiesUtils;
import com.guye.sun.common.utils.lang.StringUtils;
import com.guye.sun.common.utils.mapper.JsonMapper;
import com.guye.sun.common.utils.mapper.XmlMapper;
...
public class ServletUtils {
	...
	/**
	 * 获取当前请求对象
	 * com.guye.sun.common.utils.web.xml: <listener><listener-class>
	 * 	org.springframework.com.guye.sun.common.utils.web.context.request.RequestContextListener
	...
	/**
	 * 获取当前相应对象
	 * com.guye.sun.common.utils.web.xml: <filter><filter-name>requestContextFilter</filter-name><filter-class>
	 * 	org.springframework.com.guye.sun.common.utils.web.filter.RequestContextFilter</filter-class></filter><filter-mapping>
    ...
    public static boolean isStaticFile(String uri){
		if (staticFiles == null){
			...
			try{
				staticFiles = StringUtils.split(pl.getProperty("com.guye.sun.common.utils.web.staticFile"), ",");
				staticFileExcludeUri = StringUtils.split(pl.getProperty("com.guye.sun.common.utils.web.staticFileExcludeUri"), ",");
			}catch(NoSuchElementException nsee){
				; // 什么也不做
			}
			if (staticFiles == null){
				try {
					throw new Exception("检测到“jeesite.yml”中没有配置“com.guye.sun.common.utils.web.staticFile”属性。"
							+ "配置示例：\n#静态文件后缀\ncom.guye.sun.common.utils.web.staticFile=.css,.js,.png,.jpg,.gif,"
