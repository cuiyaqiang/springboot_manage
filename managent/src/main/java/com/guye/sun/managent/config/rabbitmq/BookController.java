...
import com.guye.sun.managent.pojo.rabbitmq_do.Book;
...
public class BookController {
    ...
    public void defaultMessage() {
        ...
        // 添加延时队列
        this.rabbitTemplate.convertAndSend(BookRabbitConfig.REGISTER_DELAY_EXCHANGE, BookRabbitConfig.DELAY_ROUTING_KEY, book, message -> {
